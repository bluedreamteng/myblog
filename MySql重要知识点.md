...
![image-20220616141351236](MySql重要知识点/image-20220616141351236.png)
...
![image-20220616142723266](MySql重要知识点/image-20220616142723266.png)
...
在没有索引的情况下，不论是根据主键列或者其他列的值进行查找，由于我们并不能快速的定位到记录所在的页，所以只能 从第一个页沿着双向链表 一直往下找，在每一个页中根据我们上面的查找方式去查 找指定的记录。因为要遍历所有的数据页，所以这种方式显然是 超级耗时 的。如果一个表有一亿条记录呢？此时索引应运而生。
...
![image-20220616152453203](MySql重要知识点/image-20220616152453203.png)
...
<img src="MySql重要知识点/image-20220616152727234.png" alt="image-20220616152727234" style="zoom:80%;" />

把一些记录放到页里的示意图就是：

![image-20220616152651878](MySql重要知识点/image-20220616152651878.png)
...
![image-20220616153518456](MySql重要知识点/image-20220616153518456.png)
...
![image-20220616155306705](MySql重要知识点/image-20220616155306705.png)
...
![image-20220616160216525](MySql重要知识点/image-20220616160216525.png)
...
![image-20220616160619525](MySql重要知识点/image-20220616160619525.png)
...
![image-20220616160857381](MySql重要知识点/image-20220616160857381.png)
...
![image-20220616162944404](MySql重要知识点/image-20220616162944404.png)
...
![image-20220616171135082](MySql重要知识点/image-20220616171135082.png)
...
![image-20220616173512780](MySql重要知识点/image-20220616173512780.png)

如图，我们生成了一个存储更高级目录项的 页33 ，这个页中的两条记录分别代表页30和页32，如果用 户记录的主键值在 [1, 320) 之间，则到页30中查找更详细的目录项记录，如果主键值 不小于320 的 话，就到页32中查找更详细的目录项记录。

我们可以用下边这个图来描述它：

![image-20220616173717538](MySql重要知识点/image-20220616173717538.png)
...
答案：我们可以`多建几棵B+树`，不同的B+树中的数据采用不同的排列规则。比方说我们用`c2`列的大小作为数据页、页中记录的排序规则，再建一课B+树，效果如下图所示：

![image-20220616203852043](MySql重要知识点/image-20220616203852043.png)

这个B+树与上边介绍的聚簇索引有几处不同：

![image-20220616210404733](MySql重要知识点/image-20220616210404733.png)
...
![image-20220616213109383](MySql重要知识点/image-20220616213109383.png)
...
![image-20220616215251172](MySql重要知识点/image-20220616215251172.png)
...
![image-20220617151918786](MySql重要知识点/image-20220617151918786.png)

如果二级索引中目录项记录的内容只是 `索引列 + 页号` 的搭配的话，那么为 `c2` 列简历索引后的B+树应该长这样：

![image-20220617152906690](MySql重要知识点/image-20220617152906690.png)
...
![image-20220617154135258](MySql重要知识点/image-20220617154135258.png)
...
<img src="MySql重要知识点/image-20220617160325201.png" alt="image-20220617160325201" style="float:left;" />

![image-20220617160413479](MySql重要知识点/image-20220617160413479.png)

<img src="MySql重要知识点/image-20220617160533122.png" alt="image-20220617160533122" style="float:left;" />

![image-20220617160625006](MySql重要知识点/image-20220617160625006.png)

<img src="MySql重要知识点/image-20220617160813548.png" alt="image-20220617160813548" style="float:left;" />
...
<img src="MySql重要知识点/image-20220617161126022.png" alt="image-20220617161126022" style="float:left;" />

![image-20220617161151125](MySql重要知识点/image-20220617161151125.png)
...
<img src="MySql重要知识点/image-20220617161635521.png" alt="image-20220617161635521" style="float:left;" />
...
<img src="MySql重要知识点/image-20220617161946230.png" alt="image-20220617161946230" style="float:left;" />
...
![image-20220617162153587](MySql重要知识点/image-20220617162153587.png)

<img src="MySql重要知识点/image-20220617162548697.png" alt="image-20220617162548697" style="float:left;" />

![image-20220617162604272](MySql重要知识点/image-20220617162604272.png)

上图中哈希函数h有可能将两个不同的关键字映射到相同的位置，这叫做 碰撞 ，在数据库中一般采用 链 接法 来解决。在链接法中，将散列到同一槽位的元素放在一个链表中，如下图所示：

![image-20220617162703006](MySql重要知识点/image-20220617162703006.png)
...
<img src="MySql重要知识点/image-20220617163202156.png" alt="image-20220617163202156" style="float:left;" />
...
<img src="MySql重要知识点/image-20220617163619721.png" alt="image-20220617163619721" style="float:left;" />

![image-20220617163657697](MySql重要知识点/image-20220617163657697.png)
...
<img src="MySql重要知识点/image-20220617163952166.png" alt="image-20220617163952166" style="float:left;" />

![image-20220617164022728](MySql重要知识点/image-20220617164022728.png)

但是特殊情况，就是有时候二叉树的深度非常大，比如：

![image-20220617164053134](MySql重要知识点/image-20220617164053134.png)

为了提高查询效率，就需要 减少磁盘IO数 。为了减少磁盘IO的次数，就需要尽量 降低树的高度 ，需要把 原来“瘦高”的树结构变的“矮胖”，树的每层的分叉越多越好。

### 6.4 AVL树

<img src="MySql重要知识点/image-20220617165045803.png" alt="image-20220617165045803" style="float:left;" />

![image-20220617165105005](MySql重要知识点/image-20220617165105005.png)
...
![image-20220617165124685](MySql重要知识点/image-20220617165124685.png)
...
![image-20220617165937875](MySql重要知识点/image-20220617165937875.png)

<img src="MySql重要知识点/image-20220617170124200.png" alt="image-20220617170124200" style="float:left;" />
...
<img src="MySql重要知识点/image-20220617170454023.png" alt="image-20220617170454023" style="float:left;" />

**再举例1：**

![image-20220617170526488](MySql重要知识点/image-20220617170526488.png)

### 6.6 B+Tree

<img src="MySql重要知识点/image-20220617170628394.png" alt="image-20220617170628394" style="float:left;" />

* MySQL官网说明：

![image-20220617170710329](MySql重要知识点/image-20220617170710329.png)
...
<img src="MySql重要知识点/image-20220617171011102.png" alt="image-20220617171011102" style="float:left;" />

![image-20220617171106671](MySql重要知识点/image-20220617171106671.png)

![image-20220617171131747](MySql重要知识点/image-20220617171131747.png)

<img src="MySql重要知识点/image-20220617171331282.png" alt="image-20220617171331282" style="float:left;" />

<img src="MySql重要知识点/image-20220617171434206.png" alt="image-20220617171434206" style="float:left;" />

> B 树和 B+ 树都可以作为索引的数据结构，在 MySQL 中采用的是 B+ 树。 但B树和B+树各有自己的应用场景，不能说B+树完全比B树好，反之亦然。

**思考题：为了减少IO，索引树会一次性加载吗？**

<img src="MySql重要知识点/image-20220617171614460.png" alt="image-20220617171614460" style="float:left;" />

**思考题：B+树的存储能力如何？为何说一般查找行记录，最多只需1~3次磁盘IO**

<img src="MySql重要知识点/image-20220617172426725.png" alt="image-20220617172426725" style="float:left;" />

**思考题：为什么说B+树比B-树更适合实际应用中操作系统的文件索引和数据库索引？**

<img src="MySql重要知识点/image-20220617175142810.png" alt="image-20220617175142810" style="float:left;" />

**思考题：Hash 索引与 B+ 树索引的区别**

<img src="MySql重要知识点/image-20220617175230327.png" alt="image-20220617175230327" style="float:left;" />

**思考题：Hash 索引与 B+ 树索引是在建索引的时候手动指定的吗？**

<img src="MySql重要知识点/image-20220617175309115.png" alt="image-20220617175309115" style="float:left;" />
...
<img src="MySql重要知识点/image-20220617175440527.png" alt="image-20220617175440527" style="float:left;" />

### 附录：算法的时间复杂度

同一问题可用不同算法解决，而一个算法的质量优劣将影响到算法乃至程序的效率。算法分析的目的在 于选择合适算法和改进算法。

![image-20220617175516191](MySql重要知识点/image-20220617175516191.png)
...
<img src="MySql重要知识点/image-20220621202759576.png" alt="image-20220621202759576" style="float:left;" />

**2. 唯一性索引**

<img src="MySql重要知识点/image-20220621202850551.png" alt="image-20220621202850551" style="float:left;" />

**3. 主键索引**

<img src="MySql重要知识点/image-20220621203302303.png" alt="image-20220621203302303" style="float:left;" />

**4. 单列索引**

<img src="MySql重要知识点/image-20220621203333925.png" alt="image-20220621203333925" style="float:left;" />

**5. 多列 (组合、联合) 索引**

<img src="MySql重要知识点/image-20220621203454424.png" alt="image-20220621203454424" style="float:left;" />

**6. 全文检索**

<img src="MySql重要知识点/image-20220621203645789.png" alt="image-20220621203645789" style="float:left;" />

**7. 补充：空间索引**

<img src="MySql重要知识点/image-20220621203736098.png" alt="image-20220621203736098" style="float:left;" />
...
![image-20220622224124267](MySql重要知识点/image-20220622224124267.png)

从结果可以看出，索引仍然是默认的升序

在MySQL 8.0版本中查看数据表ts1的结构，结果如下：

![image-20220622224205048](MySql重要知识点/image-20220622224205048.png)
...
从MySQL 8.x开始支持 隐藏索引（invisible indexes） ，只需要将待删除的索引设置为隐藏索引，使 查询优化器不再使用这个索引（即使使用force index（强制使用索引），优化器也不会使用该索引）， 确认将索引设置为隐藏索引后系统不受任何影响，就可以彻底删除索引。 这种通过先将索引设置为隐藏索引，再删除索引的方式就是软删除。
...
<img src="MySql重要知识点/image-20220623154615702.png" alt="image-20220623154615702" style="float:left;" />
...
<img src="MySql重要知识点/image-20220623175306282.png" alt="image-20220623175306282" style="float:left;" />

#### 8. 使用字符串前缀创建索引

<img src="MySql重要知识点/image-20220623175513439.png" alt="image-20220623175513439" style="float:left;" />
...
<img src="MySql重要知识点/image-20220627151947786.png" alt="image-20220627151947786" style="float:left;" />
...
![image-20220627162248635](MySql重要知识点/image-20220627162248635.png)

![image-20220627162345815](MySql重要知识点/image-20220627162345815.png)

我们可以通过观察了解数据库整体的运行状态，通过性能分析工具可以让我们了解执行慢的SQL都有哪些，查看具体的SQL执行计划，甚至是SQL执行中的每一步的成本代价，这样才能定位问题所在，找到了问题，再采取相应的行动。

**详细解释一下这张图：**

<img src="MySql重要知识点/image-20220627164046438.png" alt="image-20220627164046438" style="float:left;" />

<img src="MySql重要知识点/image-20220627164114562.png" alt="image-20220627164114562" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628173022699.png" alt="image-20220628173022699" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628173525966.png" alt="image-20220628173525966" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628175226812.png" alt="image-20220628175226812" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628175353233.png" alt="image-20220628175353233" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628175425922.png" alt="image-20220628175425922" style="zoom:80%; float:left;" />
...
<img src="MySql重要知识点/image-20220628195650079.png" alt="image-20220628195650079" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628195821440.png" alt="image-20220628195821440" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628203545536.png" alt="image-20220628203545536" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628204922556.png" alt="image-20220628204922556" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628205029208.png" alt="image-20220628205029208" style="zoom:80%;float:left" />
...
<img src="MySql重要知识点/image-20220628205243769.png" alt="image-20220628205243769" style="zoom:80%;float:left" />
...
<img src="MySql重要知识点/image-20220628205317257.png" alt="image-20220628205317257" style="float:left;" />

```mysql
mysql> show profile cpu,block io for query 2
```

<img src="MySql重要知识点/image-20220628205354230.png" alt="image-20220628205354230" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628210837301.png" alt="image-20220628210837301" style="float:left;" />
...
![image-20220628211207436](MySql重要知识点/image-20220628211207436.png)
...
<img src="MySql重要知识点/image-20220628211351678.png" alt="image-20220628211351678" style="float:left;" />
...
<img src="MySql重要知识点/image-20220628212029574.png" alt="image-20220628212029574" style="float:left;" />

EXPLAIN 语句输出的各个列的作用如下：

![image-20220628212049096](MySql重要知识点/image-20220628212049096.png)
...
![image-20220628221143339](MySql重要知识点/image-20220628221143339.png)
...
![image-20220628221414097](MySql重要知识点/image-20220628221414097.png)
...
<img src="MySql重要知识点/image-20220628221948512.png" alt="image-20220628221948512" style="float:left;" />

```mysql
mysql > EXPLAIN SELECT * FROM s1 WHERE key1 = 'a';
```

![image-20220628222055716](MySql重要知识点/image-20220628222055716.png)
...
![image-20220628222251309](MySql重要知识点/image-20220628222251309.png)
...
![image-20220629165122837](MySql重要知识点/image-20220629165122837.png)

<img src="MySql重要知识点/image-20220629170848349.png" alt="image-20220629170848349" style="float:left;" />
...
![image-20220629165603072](MySql重要知识点/image-20220629165603072.png)
...
![image-20220629165909340](MySql重要知识点/image-20220629165909340.png)

<img src="MySql重要知识点/image-20220629171104375.png" alt="image-20220629171104375" style="float:left;" />

```mysql
mysql> EXPLAIN SELECT * FROM s1 UNION ALL SELECT * FROM s2;
```

![image-20220629171138065](MySql重要知识点/image-20220629171138065.png)
...
<img src="MySql重要知识点/image-20220629171611716.png" alt="image-20220629171611716" style="float:left;" />

![image-20220629171442624](MySql重要知识点/image-20220629171442624.png)
...
![image-20220629171840300](MySql重要知识点/image-20220629171840300.png)
...
![image-20220629171904912](MySql重要知识点/image-20220629171904912.png)
...
* PRIMARY
  ...
  ![image-20220629171929924](MySql重要知识点/image-20220629171929924.png)
...
* SUBQUERY
  ...
  ![image-20220629172449267](MySql重要知识点/image-20220629172449267.png)
...
* DEPENDENT SUBQUERY
  ...
  ![image-20220629172525236](MySql重要知识点/image-20220629172525236.png)

* DEPENDENT UNION

  ![image-20230516163703426](MySql重要知识点/image-20230516163703426.png)

  ```mysql
  mysql> EXPLAIN SELECT * FROM s1 WHERE key1 IN (SELECT key1 FROM s2 WHERE key1 = 'a' UNION SELECT key1 FROM s1 WHERE key1 = 'b');
  ```

  ![image-20220629172555603](MySql重要知识点/image-20220629172555603.png)

* DERIVED

  ![image-20230516163826822](MySql重要知识点/image-20230516163826822.png)

  ```mysql
  mysql> EXPLAIN SELECT * FROM (SELECT key1, count(*) as c FROM s1 GROUP BY key1) AS derived_s1 where c > 1;
  ```

  ![image-20220629172622893](MySql重要知识点/image-20220629172622893.png)
...
* MATERIALIZED
  ...
  ![image-20220629172646367](MySql重要知识点/image-20220629172646367.png)
...
<img src="MySql重要知识点/image-20220629190304966.png" alt="image-20220629190304966" style="float:left;" />
...
<img src="MySql重要知识点/image-20220629190335371.png" alt="image-20220629190335371" style="float:left;" />
...
* `system`
  ...
  <img src="MySql重要知识点/image-20220630164434315.png" alt="image-20220630164434315" style="float:left;" />
...
* `const`
  ...
  <img src="MySql重要知识点/image-20220630164724548.png" alt="image-20220630164724548" style="float:left;" />
...
* `eq_ref`
  ...
  <img src="MySql重要知识点/image-20220630164802559.png" alt="image-20220630164802559" style="float:left;" />
...
* `ref`
  ...
  <img src="MySql重要知识点/image-20220630164930020.png" alt="image-20220630164930020" style="float:left;" />
...
* `ref_or_null`
  ...
  <img src="MySql重要知识点/image-20220630175133920.png" alt="image-20220630175133920" style="float:left;" />
...
* `index_merge`
  ...
  <img src="MySql重要知识点/image-20220630175511644.png" alt="image-20220630175511644" style="float:left;" />
...
* `unique_subquery`
  ...
  <img src="MySql重要知识点/image-20220630180123913.png" alt="image-20220630180123913" style="float:left;" />
...
![image-20220703214407225](MySql重要知识点/image-20220703214407225.png)
...
* `range`
  ...
  ![image-20220703214633338](MySql重要知识点/image-20220703214633338.png)
  ...
  ![image-20220703214657251](MySql重要知识点/image-20220703214657251.png)
...
* `index`
  ...
  ![image-20220703214844885](MySql重要知识点/image-20220703214844885.png)
...
* `ALL`
  ...
  ![image-20220703215958374](MySql重要知识点/image-20220703215958374.png)
...
![image-20220703220724964](MySql重要知识点/image-20220703220724964.png)
...
![image-20220704130030692](MySql重要知识点/image-20220704130030692.png)
...
![image-20220704130138204](MySql重要知识点/image-20220704130138204.png)
...
![image-20220704130214482](MySql重要知识点/image-20220704130214482.png)
...
![image-20220704130442095](MySql重要知识点/image-20220704130442095.png)

```mysql
mysql> EXPLAIN SELECT * FROM s1 WHERE key_part1 = 'a' AND key_part2 = 'b';
```

![image-20220704130515031](MySql重要知识点/image-20220704130515031.png)
...
<img src="MySql重要知识点/image-20220704131759630.png" alt="image-20220704131759630" style="float:left;" />

```mysql
mysql> EXPLAIN SELECT * FROM s1 WHERE key1 = 'a';
```

![image-20220704130837498](MySql重要知识点/image-20220704130837498.png)
...
![image-20220704130925426](MySql重要知识点/image-20220704130925426.png)

```mysql
mysql> EXPLAIN SELECT * FROM s1 INNER JOIN s2 ON s2.key1 = UPPER(s1.key1);
```

![image-20220704130957359](MySql重要知识点/image-20220704130957359.png)
...
![image-20220704131050496](MySql重要知识点/image-20220704131050496.png)
...
![image-20220704131323242](MySql重要知识点/image-20220704131323242.png)
...
![image-20220704131644615](MySql重要知识点/image-20220704131644615.png)
...
* `No tables used`
  ...
  ![image-20220704132345383](MySql重要知识点/image-20220704132345383.png)
...
* `Impossible WHERE`
  ...
  ![image-20220704132458978](MySql重要知识点/image-20220704132458978.png)

* `Using where`

  <img src="MySql重要知识点/image-20220704140148163.png" alt="image-20220704140148163" style="float:left;" />

  ```mysql
  mysql> EXPLAIN SELECT * FROM s1 WHERE common_field = 'a';
  ```

  ![image-20220704132655342](MySql重要知识点/image-20220704132655342.png)

  <img src="MySql重要知识点/image-20220704140212813.png" alt="image-20220704140212813" style="float:left;" />

  ```mysql
  mysql> EXPLAIN SELECT * FROM s1 WHERE key1 = 'a' AND common_field = 'a';
  ```

  ![image-20220704133130515](MySql重要知识点/image-20220704133130515.png)
...
* `No matching min/max row`
  ...
  ![image-20220704134324354](MySql重要知识点/image-20220704134324354.png)
...
* `Using index`
  ...
  ![image-20220704134931220](MySql重要知识点/image-20220704134931220.png)
...
* `Using index condition`
  ...
  <img src="MySql重要知识点/image-20220704140344015.png" alt="image-20220704140344015" style="float:left;" />

  <img src="MySql重要知识点/image-20220704140411033.png" alt="image-20220704140411033" style="float:left;" />

  ```mysql
  mysql> EXPLAIN SELECT * FROM s1 WHERE key1 > 'z' AND key1 LIKE '%b';
  ```

  ![image-20220704140441702](MySql重要知识点/image-20220704140441702.png)
...
* `Using join buffer (Block Nested Loop)`
  ...
  ![image-20220704140815955](MySql重要知识点/image-20220704140815955.png)
...
* `Not exists`
  ...
  ![image-20220704142059555](MySql重要知识点/image-20220704142059555.png)
...
* `Using intersect(...) 、 Using union(...) 和 Using sort_union(...)`
  ...
  ![image-20220704142552890](MySql重要知识点/image-20220704142552890.png)
...
* `Zero limit`
  ...
  ![image-20220704142754394](MySql重要知识点/image-20220704142754394.png)
...
* `Using filesort`
  ...
  ![image-20220704142901857](MySql重要知识点/image-20220704142901857.png)

  <img src="MySql重要知识点/image-20220704145143170.png" alt="image-20220704145143170" style="float:left;" />

  ```mysql
  mysql> EXPLAIN SELECT * FROM s1 ORDER BY common_field LIMIT 10;
  ```

  ![image-20220704143518857](MySql重要知识点/image-20220704143518857.png)

  需要注意的是，如果查询中需要使用`filesort`的方式进行排序的记录非常多，那么这个过程是很耗费性能的，我们最好想办法`将使用文件排序的执行方式改为索引进行排序`。

* `Using temporary`

  <img src="MySql重要知识点/image-20220704145924130.png" alt="image-20220704145924130" style="float:left;" />

  ```mysql
  mysql> EXPLAIN SELECT DISTINCT common_field FROM s1;
  ```

  ![image-20220704150030005](MySql重要知识点/image-20220704150030005.png)
  ...
  ![image-20220704150156416](MySql重要知识点/image-20220704150156416.png)
  ...
  ![image-20220704150308189](MySql重要知识点/image-20220704150308189.png)
...
![image-20220704161702384](MySql重要知识点/image-20220704161702384.png)
...
![image-20220704164236909](MySql重要知识点/image-20220704164236909.png)
...
![image-20220704172833362](MySql重要知识点/image-20220704172833362.png)

![image-20220704172920158](MySql重要知识点/image-20220704172920158.png)

![image-20220704173012413](MySql重要知识点/image-20220704173012413.png)

![image-20220704173045190](MySql重要知识点/image-20220704173045190.png)

![image-20220704173108888](MySql重要知识点/image-20220704173108888.png)
...
![image-20220704174401970](MySql重要知识点/image-20220704174401970.png)
...
![image-20220704174543663](MySql重要知识点/image-20220704174543663.png)
...
<img src="MySql重要知识点/image-20220704175711800.png" alt="image-20220704175711800" style="float:left;" />
...
<img src="MySql重要知识点/image-20220704190726180.png" alt="image-20220704190726180" style="float:left;" />
...
<img src="MySql重要知识点/image-20220704192020603.png" alt="image-20220704192020603" style="float:left;" />
...
<img src="MySql重要知识点/image-20220704202453482.png" alt="image-20220704202453482" style="float:left;" />
...
<img src="MySql重要知识点/image-20220704204140589.png" alt="image-20220704204140589" style="float:left;" />
...
![image-20220704211116351](MySql重要知识点/image-20220704211116351.png)
...
![image-20220704211254581](MySql重要知识点/image-20220704211254581.png)
...
<img src="MySql重要知识点/image-20220704212354041.png" alt="image-20220704212354041" style="float:left;" />

如果此时再插入一条主键值为 9 的记录，那它插入的位置就如下图：

![image-20220704212428607](MySql重要知识点/image-20220704212428607.png)
...
4. 第二种：索引优化失效
   ...
   ![image-20220704214905412](MySql重要知识点/image-20220704214905412.png)
...
![image-20220704215159768](MySql重要知识点/image-20220704215159768.png)
...
* student表的字段name上设置有索引
  ...
  ![image-20220704215533871](MySql重要知识点/image-20220704215533871.png)
...
* 索引优化生效
  ...
  ![image-20220704215600507](MySql重要知识点/image-20220704215600507.png)
...
![image-20220704215658526](MySql重要知识点/image-20220704215658526.png)
...
![image-20220704215721216](MySql重要知识点/image-20220704215721216.png)
...
![image-20220704220123647](MySql重要知识点/image-20220704220123647.png)
...
![image-20220704223211981](MySql重要知识点/image-20220704223211981.png)
...
![image-20220704224552374](MySql重要知识点/image-20220704224552374.png)
...
![image-20220704224916117](MySql重要知识点/image-20220704224916117.png)
...
![image-20220704225333199](MySql重要知识点/image-20220704225333199.png)
...
![image-20220705131643304](MySql重要知识点/image-20220705131643304.png)
...
![image-20220705131717329](MySql重要知识点/image-20220705131717329.png)
...
![image-20220705132221045](MySql重要知识点/image-20220705132221045.png)
...
![image-20220705132239232](MySql重要知识点/image-20220705132239232.png)
...
![image-20220705145225852](MySql重要知识点/image-20220705145225852.png)
...
![image-20220705160504018](MySql重要知识点/image-20220705160504018.png)
...
![image-20220705160935109](MySql重要知识点/image-20220705160935109.png)
...
![image-20220705161243838](MySql重要知识点/image-20220705161243838.png)
...
![image-20220705161515545](MySql重要知识点/image-20220705161515545.png)
...
![image-20220705161602362](MySql重要知识点/image-20220705161602362.png)
...
![image-20220705161746184](MySql重要知识点/image-20220705161746184.png)
...
![image-20220705161843558](MySql重要知识点/image-20220705161843558.png)
...
![image-20220705161929544](MySql重要知识点/image-20220705161929544.png)
...
![image-20220705162009145](MySql重要知识点/image-20220705162009145.png)
...
![image-20220705163833445](MySql重要知识点/image-20220705163833445.png)
...
![image-20220705165559127](MySql重要知识点/image-20220705165559127.png)

可以看到这种方式效率是非常低的，以上述表A数据100条，表B数据1000条计算，则A*B=10万次。开销统计如下:

![image-20220705165646252](MySql重要知识点/image-20220705165646252.png)
...
![image-20220705172315554](MySql重要知识点/image-20220705172315554.png)

驱动表中的每条记录通过被驱动表的索引进行访问，因为索引查询的成本是比较固定的，故mysql优化器都倾向于使用记录数少的表作为驱动表（外表）。

![image-20220705172650749](MySql重要知识点/image-20220705172650749.png)

如果被驱动表加索引，效率是非常高的，但如果索引不是主键索引，所以还得进行一次回表查询。相比，被驱动表的索引是主键索引，效率会更高。

#### 4. Block Nested-Loop Join（块嵌套循环连接）

<img src="MySql重要知识点/image-20220705173047234.png" alt="image-20220705173047234" style="float:left;" />
...
![image-20220705174005280](MySql重要知识点/image-20220705174005280.png)

![image-20220705174250551](MySql重要知识点/image-20220705174250551.png)
...
![image-20220705205050280](MySql重要知识点/image-20220705205050280.png)
...
![image-20220705210708343](MySql重要知识点/image-20220705210708343.png)
...
![image-20220705210839437](MySql重要知识点/image-20220705210839437.png)
...
![image-20220705215436102](MySql重要知识点/image-20220705215436102.png)

**过程二： order by 时不limit,索引失效**

![image-20220705215909350](MySql重要知识点/image-20220705215909350.png)

**过程三：order by 时顺序错误，索引失效**

<img src="MySql重要知识点/image-20220705220033520.png" alt="image-20220705220033520" style="zoom:80%;float:left" />

**过程四：order by 时规则不一致，索引失效（顺序错，不索引；方向反，不索引）**

<img src="MySql重要知识点/image-20220705220404802.png" alt="image-20220705220404802" style="zoom:80%;float:left" />

> 结论：ORDER BY 子句，尽量使用 Index 方式排序，避免使用 FileSort 方式排序

**过程五：无过滤，不索引**

<img src="MySql重要知识点/image-20220705221212879.png" alt="image-20220705221212879" style="zoom:80%;float:left" />
...
![image-20220705222027812](MySql重要知识点/image-20220705222027812.png)
...
![image-20220705222912521](MySql重要知识点/image-20220705222912521.png)

这样我们优化掉了 using filesort

查询结果如下：

<img src="MySql重要知识点/image-20220705222954971.png" alt="image-20220705222954971" style="float:left;" />
...
![image-20220705223111883](MySql重要知识点/image-20220705223111883.png)
...
<img src="MySql重要知识点/image-20220705223329164.png" alt="image-20220705223329164" style="zoom:80%;float:left" />
...
<img src="MySql重要知识点/image-20220705224410340.png" alt="image-20220705224410340" style="zoom:80%;float:left" />

**2. 尝试提高 max_length_for_sort_data**

<img src="MySql重要知识点/image-20220705224505668.png" alt="image-20220705224505668" style="zoom:80%;float:left" />

**3. Order by 时select * 是一个大忌。最好只Query需要的字段。**

<img src="MySql重要知识点/image-20220705224551104.png" alt="image-20220705224551104" style="float:left;" />
...
<img src="MySql重要知识点/image-20220705225329130.png" alt="image-20220705225329130" style="float:left;" />
...
![image-20220705225625166](MySql重要知识点/image-20220705225625166.png)
...
![image-20220705225654124](MySql重要知识点/image-20220705225654124.png)
...
![image-20220706124528680](MySql重要知识点/image-20220706124528680.png)
...
![image-20220706124612180](MySql重要知识点/image-20220706124612180.png)
...
![image-20220706125113658](MySql重要知识点/image-20220706125113658.png)
...
![image-20220706125351116](MySql重要知识点/image-20220706125351116.png)

### 8.2 覆盖索引的利弊

<img src="MySql重要知识点/image-20220706125943936.png" alt="image-20220706125943936" style="zoom:80%;float:left" />
...
![image-20220706130901307](MySql重要知识点/image-20220706130901307.png)

以及

<img src="MySql重要知识点/image-20220706130921934.png" alt="image-20220706130921934" style="zoom:70%;" />
...
<img src="MySql重要知识点/image-20220706131320477.png" alt="image-20220706131320477" style="zoom:80%;float:left" />
...
<img src="MySql重要知识点/image-20220706135436316.png" alt="image-20220706135436316" style="zoom:80%;float:left" />

<img src="MySql重要知识点/image-20220706135506409.png" alt="image-20220706135506409" style="zoom:80%;float:left" />

* 主键索引 (简图)

![image-20220706135633814](MySql重要知识点/image-20220706135633814.png)

二级索引zip_last_first (简图，这里省略了数据页等信息)

![image-20220706135701187](MySql重要知识点/image-20220706135701187.png)

<img src="MySql重要知识点/image-20220706135723203.png" alt="image-20220706135723203" style="zoom:80%;float:left" />

### 10.4 开启和关闭ICP性能对比

<img src="MySql重要知识点/image-20220706135904713.png" alt="image-20220706135904713" style="zoom:80%;float:left" />

<img src="MySql重要知识点/image-20220706140213382.png" alt="image-20220706140213382" style="zoom:80%;float:left" />
...
<img src="MySql重要知识点/image-20220706141957185.png" alt="image-20220706141957185" style="zoom:80%;float:left" />
...
<img src="MySql重要知识点/image-20220706142648452.png" alt="image-20220706142648452" style="zoom:80%;float:left" />
...
![image-20220706151506580](MySql重要知识点/image-20220706151506580.png)
...
![image-20220706151715106](MySql重要知识点/image-20220706151715106.png)
...
![image-20220706161436920](MySql重要知识点/image-20220706161436920.png)
...
![image-20220706162131362](MySql重要知识点/image-20220706162131362.png)
...
![image-20220706162657448](MySql重要知识点/image-20220706162657448.png)
...
<img src="MySql重要知识点/image-20220706162947613.png" alt="image-20220706162947613" style="zoom:67%;" />
...
<img src="MySql重要知识点/image-20220706164201695.png" alt="image-20220706164201695" style="zoom:80%;float:left" />

<img src="MySql重要知识点/image-20220706164359539.png" alt="image-20220706164359539" style="zoom:80%;float:left" />
...
![image-20220706165020939](MySql重要知识点/image-20220706165020939.png)

### 2.3 键和相关属性的概念

<img src="MySql重要知识点/image-20220706165231022.png" alt="image-20220706165231022" style="float:left;" />
...
![image-20220706171057270](MySql重要知识点/image-20220706171057270.png)

该表不符合 1NF ，因为规则说“表的每个属性必须具有原子（单个）值”，lisi和zhaoliu员工的 emp_mobile 值违反了该规则。为了使表符合 1NF ，我们应该有如下表数据：

![image-20220706171130851](MySql重要知识点/image-20220706171130851.png)

**举例2：**

user 表的设计不符合第一范式

![image-20220706171225292](MySql重要知识点/image-20220706171225292.png)

其中，user_info字段为用户信息，可以进一步拆分成更小粒度的字段，不符合数据库设计对第一范式的 要求。将user_info拆分后如下：

![image-20220706171242455](MySql重要知识点/image-20220706171242455.png)
...
![image-20220706171442919](MySql重要知识点/image-20220706171442919.png)

表2：

![image-20220706171456873](MySql重要知识点/image-20220706171456873.png)
...
![image-20220707122639894](MySql重要知识点/image-20220707122639894.png)
...
![image-20220707123038469](MySql重要知识点/image-20220707123038469.png)
...
![image-20220707123104009](MySql重要知识点/image-20220707123104009.png)
...
![image-20220707124011654](MySql重要知识点/image-20220707124011654.png)
...
![image-20220707124040899](MySql重要知识点/image-20220707124040899.png)

表2：符合第三范式的 `商品表` 的设计

![image-20220707124058174](MySql重要知识点/image-20220707124058174.png)
...
![image-20220707124136228](MySql重要知识点/image-20220707124136228.png)

你能看到球员编号决定了球队名称，同时球队名称决定了球队主教练，非主属性球队主教练就会传递依 赖于球员编号，因此不符合 3NF 的要求。

如果要达到 3NF 的要求，需要把数据表拆成下面这样：

![image-20220707124152312](MySql重要知识点/image-20220707124152312.png)
...
![image-20220707124212114](MySql重要知识点/image-20220707124212114.png)

> 符合3NF后的数据模型通俗地讲，2NF和3NF通常以这句话概括：“每个非键属性依赖于键，依赖于 整个键，并且除了键别无他物”。

### 2.7 小结

<img src="MySql重要知识点/image-20220707124343085.png" alt="image-20220707124343085" style="zoom:80%;float:left" />

## 3. 反范式化

### 3.1 概述

<img src="MySql重要知识点/image-20220707124741675.png" alt="image-20220707124741675" style="zoom:80%;float:left" />
...
![image-20220707125118808](MySql重要知识点/image-20220707125118808.png)
...
![image-20220707125401029](MySql重要知识点/image-20220707125401029.png)

商品信息表：

![image-20220707125447317](MySql重要知识点/image-20220707125447317.png)

新的商品流水表如下所示：

![image-20220707125500378](MySql重要知识点/image-20220707125500378.png)

**举例4：**

`课程评论表 class_comment` ，对应的字段名称及含义如下：

![image-20220707125531172](MySql重要知识点/image-20220707125531172.png)

`学生表 student` ，对应的字段名称及含义如下：

<img src="MySql重要知识点/image-20220707125545891.png" alt="image-20220707125545891" style="zoom:80%;" />
...
<img src="MySql重要知识点/image-20220707125642908.png" alt="image-20220707125642908" style="zoom:80%;" />
...
<img src="MySql重要知识点/image-20220707125718469.png" alt="image-20220707125718469" style="zoom:80%;" />
...
<img src="MySql重要知识点/image-20220707131428597.png" alt="image-20220707131428597" style="zoom:80%;" />
...
![image-20220707132038425](MySql重要知识点/image-20220707132038425.png)
...
![image-20220707132344634](MySql重要知识点/image-20220707132344634.png)

导师表：

![image-20220707132355841](MySql重要知识点/image-20220707132355841.png)
...
![image-20220707133830721](MySql重要知识点/image-20220707133830721.png)
...
![image-20220707134028730](MySql重要知识点/image-20220707134028730.png)

以及

![image-20220707134220820](MySql重要知识点/image-20220707134220820.png)
...
![image-20220707134636225](MySql重要知识点/image-20220707134636225.png)
...
![image-20220707154400580](MySql重要知识点/image-20220707154400580.png)
...
<img src="MySql重要知识点/image-20220707163807205.png" alt="image-20220707163807205" style="float:left;" />

进货单表：

<img src="MySql重要知识点/image-20220707163828614.png" alt="image-20220707163828614" style="float:left;" />
...
![image-20220707164128704](MySql重要知识点/image-20220707164128704.png)

进货单明细表：

![image-20220707164146216](MySql重要知识点/image-20220707164146216.png)

商品信息表：

![image-20220707164227845](MySql重要知识点/image-20220707164227845.png)
...
<img src="MySql重要知识点/image-20220707165011050.png" alt="image-20220707165011050" style="float:left;" />

进货单头表：

<img src="MySql重要知识点/image-20220707165038108.png" alt="image-20220707165038108" style="float:left;" />

这2个表都满足第三范式的要求了。

### 7.4 反范式化：业务优先的原则

<img src="MySql重要知识点/image-20220707165459547.png" alt="image-20220707165459547" style="zoom:80%;float:left" />
...
<img src="MySql重要知识点/image-20220707164146216.png" alt="image-20220707164146216" style="zoom:80%;float:left" />

商品信息表：

<img src="MySql重要知识点/image-20220707164227845.png" alt="image-20220707164227845" style="zoom:80%;float:left" />

这样一来，我们就避免了冗余数据，而且还能够满足业务的需求，这样的数据库设计，才是合格的设计。

## 8. ER模型

<img src="MySql重要知识点/image-20220707170027637.png" alt="image-20220707170027637" style="zoom:80%;float:left" />
...
![image-20220707170608782](MySql重要知识点/image-20220707170608782.png)
...
![image-20220707171022246](MySql重要知识点/image-20220707171022246.png)
...
<img src="MySql重要知识点/image-20220707171335255.png" alt="image-20220707171335255" style="float:left;" />

<img src="MySql重要知识点/image-20220707171412363.png" alt="image-20220707171412363" style="float:left;" />

<img src="MySql重要知识点/image-20220707171915637.png" alt="image-20220707171915637" style="float:left;" />

**下面我们再把弱实体转换成数据表：**

<img src="MySql重要知识点/image-20220707172033399.png" alt="image-20220707172033399" style="float:left;" />

<img src="MySql重要知识点/image-20220707172052236.png" alt="image-20220707172052236" style="float:left;" />

<img src="MySql重要知识点/image-20220707172143793.png" alt="image-20220707172143793" style="float:left;" />

<img src="MySql重要知识点/image-20220707172217772.png" alt="image-20220707172217772" style="float:left;" />

<img src="MySql重要知识点/image-20220707172236606.png" alt="image-20220707172236606" style="float:left;" />

<img src="MySql重要知识点/image-20220707172259143.png" alt="image-20220707172259143" style="float:left;" />

#### 2. 一个多对多的关系转换成一个数据表

<img src="MySql重要知识点/image-20220707172350226.png" alt="image-20220707172350226" style="float:left;" />

#### 3. 通过外键来表达1对多的关系

<img src="MySql重要知识点/image-20220707172609833.png" alt="image-20220707172609833" style="float:left;" />

#### 4. 把属性转换成表的字段

<img src="MySql重要知识点/image-20220707172819174.png" alt="image-20220707172819174" style="float:left;" />

![image-20220707172918017](MySql重要知识点/image-20220707172918017.png)
...
<img src="MySql重要知识点/image-20220707173028203.png" alt="image-20220707173028203" style="float:left;" />

**2. 数据表中的字段个数越少越好**

<img src="MySql重要知识点/image-20220707173402491.png" alt="image-20220707173402491" style="float:left;" />

**3. 数据表中联合主键的字段个数越少越好**

<img src="MySql重要知识点/image-20220707173522971.png" alt="image-20220707173522971" style="float:left;" />

**4. 使用主键和外键越多越好**

<img src="MySql重要知识点/image-20220707173557568.png" alt="image-20220707173557568" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707175250944.png" alt="image-20220707175250944" style="zoom:80%;float:left" />
...
<img src="MySql重要知识点/image-20220707175350250.png" alt="image-20220707175350250" style="float:left;" />

点击上面的ok，即可出现下图左边的概念模型1，可以自定义概念模型的名字，在概念模型中使用最多的 就是如图所示的Entity(实体),Relationship(关系)

<img src="MySql重要知识点/image-20220707175604026.png" alt="image-20220707175604026" style="float:left;" />

**Entity实体**

选中右边框中Entity这个功能，即可出现下面这个方框，需要注意的是书写name的时候，code自行补全，name可以是英文的也可以是中文的，但是code必须是英文的。

<img src="MySql重要知识点/image-20220707175653689.png" alt="image-20220707175653689" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707175805226.png" alt="image-20220707175805226" style="float:left;" />

在此上图说明name和code的起名方法

<img src="MySql重要知识点/image-20220707175827417.png" alt="image-20220707175827417" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707175858031.png" alt="image-20220707175858031" style="float:left;" />

**放大模型**

创建好概念数据模型如图所示，但是创建好的字体很小，读者可以按着ctrl键同时滑动鼠标的可滑动按钮 即可放大缩写字体，同时也可以看到主标识符有一个*号的标志，同时也显示出来了，name,Data type和 length这些可见的属性

<img src="MySql重要知识点/image-20220707175925155.png" alt="image-20220707175925155" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707175954634.png" alt="image-20220707175954634" style="float:left;" />

需要注意的是点击Relationship这个按钮，就把班级和学生联系起来了，就是一条线，然后双击这条线进 行编辑，在General这块起name和code

<img src="MySql重要知识点/image-20220707180021612.png" alt="image-20220707180021612" style="float:left;" />

上面的name和code起好后就可以在Cardinalities这块查看班级和学生的关系，可以看到班级的一端是一 条线，学生的一端是三条，代表班级对学生是一对多的关系即one对many的关系，点击应用，然后确定 即可

<img src="MySql重要知识点/image-20220707180044291.png" alt="image-20220707180044291" style="float:left;" />

一对多和多对一练习完还有多对多的练习，如下图操作所示，老师实体和上面介绍的一样，自己将 name，data type等等修改成自己需要的即可，满足项目开发需求即可。（comment是解释说明，自己可以写相关的介绍和说明）

<img src="MySql重要知识点/image-20220707180113532.png" alt="image-20220707180113532" style="float:left;" />

多对多需要注意的是自己可以手动点击按钮将关系调整称为多对多的关系many对many的关系，然后点击应用和确定即可

<img src="MySql重要知识点/image-20220707180159184.png" alt="image-20220707180159184" style="float:left;" />

综上即可完成最简单的学生，班级，教师这种概念数据模型的设计，需要考虑数据的类型和主标识码， 是否为空。关系是一对一还是一对多还是多对多的关系，自己需要先规划好再设计，然后就ok了。

![image-20220707180254510](MySql重要知识点/image-20220707180254510.png)
...
<img src="MySql重要知识点/image-20220707180327712.png" alt="image-20220707180327712" style="float:left;" />

创建好主页面如图所示，但是右边的按钮和概念模型略有差别，物理模型最常用的三个是 `table(表)` ， `view(视图)`， `reference(关系) `；

<img src="MySql重要知识点/image-20220707180418090.png" alt="image-20220707180418090" style="float:left;" />

鼠标先点击右边table这个按钮然后在新建的物理模型点一下，即可新建一个表，然后双击新建如下图所示，在General的name和code填上自己需要的，点击应用即可），如下图：

<img src="MySql重要知识点/image-20220707180449212.png" alt="image-20220707180449212" style="float:left;" />

然后点击Columns,如下图设置，非常简单，需要注意的就是P（primary主键） , F （foreign key外键） , M（mandatory强制性的，代表不可为空） 这三个。

<img src="MySql重要知识点/image-20220707180537251.png" alt="image-20220707180537251" style="float:left;" />

在此设置学号的自增（MYSQL里面的自增是这个AUTO_INCREMENT），班级编号同理，不多赘述！

<img src="MySql重要知识点/image-20220707180556645.png" alt="image-20220707180556645" style="float:left;" />

在下面的这个点上对号即可，就设置好了自增

<img src="MySql重要知识点/image-20220707180619440.png" alt="image-20220707180619440" style="float:left;" />

全部完成后如下图所示。

<img src="MySql重要知识点/image-20220707180643107.png" alt="image-20220707180643107" style="float:left;" />

班级物理模型同理如下图所示创建即可

<img src="MySql重要知识点/image-20220707180723698.png" alt="image-20220707180723698" style="float:left;" />

<img src="MySql重要知识点/image-20220707180744600.png" alt="image-20220707180744600" style="float:left;" />

完成后如下图所示

<img src="MySql重要知识点/image-20220707180806150.png" alt="image-20220707180806150" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707180828164.png" alt="image-20220707180828164" style="float:left;" />

做完上面的操作，就可以双击中间的一条线，显示如下图，修改name和code即可

<img src="MySql重要知识点/image-20220707183743297.png" alt="image-20220707183743297" style="float:left;" />

但是需要注意的是，修改完毕后显示的结果却如下图所示，并没有办法直接像概念模型那样，修改过后 显示在中间的那条线上面，自己明白即可。

<img src="MySql重要知识点/image-20220707193816176.png" alt="image-20220707193816176" style="float:left;" />

学习了多对一或者一对多的关系，接下来学习多对对的关系，同理自己建好老师表，这里不在叙述，记得老师编号自增，建好如下图所示

<img src="MySql重要知识点/image-20220707193932694.png" alt="image-20220707193932694" style="float:left;" />

下面是多对多关系的关键，由于物理模型多对多的关系需要一个中间表来连接，如下图，只设置一个字 段，主键，自增

<img src="MySql重要知识点/image-20220707193957629.png" alt="image-20220707193957629" style="float:left;" />

点击应用，然后设置Columns，只添加一个字段

<img src="MySql重要知识点/image-20220707194048843.png" alt="image-20220707194048843" style="float:left;" />

这是设置字段递增，前面已经叙述过好几次

<img src="MySql重要知识点/image-20220707194111885.png" alt="image-20220707194111885" style="float:left;" />

设置好后如下图所示，需要注意的是有箭头的一方是一，无箭头的一方是多，即一对多的多对一的关系 需要搞清楚，学生也可以有很多老师，老师也可以有很多学生，所以学生和老师都可以是主体；

<img src="MySql重要知识点/image-20220707194138137.png" alt="image-20220707194138137" style="float:left;" />

可以看到添加关系以后学生和教师的关系表前后发生的变化

<img src="MySql重要知识点/image-20220707194158936.png" alt="image-20220707194158936" style="float:left;" />

### 11.4 概念模型转为物理模型

1：如下图所示先打开概念模型图，然后点击Tool,如下图所示

![image-20220707194228064](MySql重要知识点/image-20220707194228064.png)

点开的页面如下所示，name和code已经从概念模型1改成物理模型1了

![image-20220707194248236](MySql重要知识点/image-20220707194248236.png)

完成后如下图所示，将自行打开修改的物理模型，需要注意的是这些表的数据类型已经自行改变了，而 且中间表出现两个主键，即双主键

![image-20220707194308595](MySql重要知识点/image-20220707194308595.png)

### 11.5 物理模型转为概念模型

上面介绍了概念模型转物理模型，下面介绍一下物理模型转概念模型（如下图点击操作即可）

![image-20220707194405358](MySql重要知识点/image-20220707194405358.png)

然后出现如下图所示界面，然后将物理修改为概念 ，点击应用确认即可

![image-20220707194419360](MySql重要知识点/image-20220707194419360.png)

点击确认后将自行打开如下图所示的页面，自己观察有何变化，如果转换为oracle的，数据类型会发生变 化，比如Varchar2等等）；

![image-20220707194433407](MySql重要知识点/image-20220707194433407.png)

###  11.6 物理模型导出SQL语句

![image-20220707194544714](MySql重要知识点/image-20220707194544714.png)

打开之后如图所示，修改好存在sql语句的位置和生成文件的名称即可

![image-20220707194557554](MySql重要知识点/image-20220707194557554.png)

在Selection中选择需要导出的表，然后点击应用和确认即可

![image-20220707194637242](MySql重要知识点/image-20220707194637242.png)

完成以后出现如下图所示，可以点击Edit或者close按钮

![image-20220707194727849](MySql重要知识点/image-20220707194727849.png)
...
<img src="MySql重要知识点/image-20220707200915836.png" alt="image-20220707200915836" style="float:left;" />

如何确定呢？一般情况下，有如下几种方式：

<img src="MySql重要知识点/image-20220707201133424.png" alt="image-20220707201133424" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707201443229.png" alt="image-20220707201443229" style="float:left;" />

#### 第2步：优化表设计

<img src="MySql重要知识点/image-20220707201617799.png" alt="image-20220707201617799" style="float:left;" />

#### 第3步：优化逻辑查询

<img src="MySql重要知识点/image-20220707202059972.png" alt="image-20220707202059972" style="float:left;" />

#### 第4步：优化物理查询

物理查询优化是在确定了逻辑查询优化之后，采用物理优化技术（比如索引等），通过计算代价模型对 各种可能的访问路径进行估算，从而找到执行方式中代价最小的作为执行计划。**在这个部分中，我们需要掌握的重点是对索引的创建和使用。**

<img src="MySql重要知识点/image-20220707202156660.png" alt="image-20220707202156660" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707202436467.png" alt="image-20220707202436467" style="float:left;" />

#### 第6步：库级优化

<img src="MySql重要知识点/image-20220707202555506.png" alt="image-20220707202555506" style="float:left;" />

<img src="MySql重要知识点/image-20220707202732911.png" alt="image-20220707202732911" style="float:left;" />

<img src="MySql重要知识点/image-20220707203538155.png" alt="image-20220707203538155" style="float:left;" />

<img src="MySql重要知识点/image-20220707203607993.png" alt="image-20220707203607993" style="float:left;" />

> 但需要注意的是，分拆在提升数据库性能的同时，也会增加维护和使用成本。

## 2. 优化MySQL服务器

<img src="MySql重要知识点/image-20220707203818987.png" alt="image-20220707203818987" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707204403406.png" alt="image-20220707204403406" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707210351452.png" alt="image-20220707210351452" style="float:left;" />

**(1) 调整系统参数 InnoDB_flush_log_at_trx_commit**

<img src="MySql重要知识点/image-20220707210447501.png" alt="image-20220707210447501" style="float:left;" />

**(2)  调整系统参数 InnoDB_buffer_pool_size**

<img src="MySql重要知识点/image-20220707210555848.png" alt="image-20220707210555848" style="float:left;" />

**(3) 调整系统参数 InnoDB_buffer_pool_instances**

<img src="MySql重要知识点/image-20220707210720394.png" alt="image-20220707210720394" style="float:left;" />

## 3. 优化数据库结构

<img src="MySql重要知识点/image-20220707211709553.png" alt="image-20220707211709553" style="float:left;" />

### 3.1 拆分表：冷热数据分离

<img src="MySql重要知识点/image-20220707211802756.png" alt="image-20220707211802756" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707212800544.png" alt="image-20220707212800544" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707213524137.png" alt="image-20220707213524137" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707214640374.png" alt="image-20220707214640374" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707215305640.png" alt="image-20220707215305640" style="float:left;" />

**② 禁用唯一性检查**

<img src="MySql重要知识点/image-20220707215356893.png" alt="image-20220707215356893" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707220034534.png" alt="image-20220707220034534" style="float:left;" />

**③ 禁止自动提交**

<img src="MySql重要知识点/image-20220707220131891.png" alt="image-20220707220131891" style="float:left;" />

### 3.6 使用非空约束

<img src="MySql重要知识点/image-20220707220157606.png" alt="image-20220707220157606" style="float:left;" />
...
![image-20220707221707254](MySql重要知识点/image-20220707221707254.png)
...
![image-20220707221901664](MySql重要知识点/image-20220707221901664.png)
...
<img src="MySql重要知识点/image-20220707222156765.png" alt="image-20220707222156765" style="float:left;" />

**方式二：使用mysqlcheck命令**

<img src="MySql重要知识点/image-20220707222305302.png" alt="image-20220707222305302" style="float:left;" />
...
![image-20220707222606097](MySql重要知识点/image-20220707222606097.png)

* 双主双从模式：

![image-20220707222623485](MySql重要知识点/image-20220707222623485.png)

### 4.3 垂直拆分

当数据量级达到 `千万级` 以上时，有时候我们需要把一个数据库切成多份，放到不同的数据库服务器上， 减少对单一数据库服务器的访问压力。

![image-20220707222648112](MySql重要知识点/image-20220707222648112.png)

* 如果数据库的数据表过多，可以采用`垂直分库`的方式，将关联的数据库部署在同一个数据库上。
* 如果数据库中的列过多，可以采用`垂直分表`的方式，将一张数据表分拆成多张数据表，把经常一起使用的列放在同一张表里。

![image-20220707222910740](MySql重要知识点/image-20220707222910740.png)
...
<img src="MySql重要知识点/image-20220707222954304.png" alt="image-20220707222954304" style="float:left;" />

![image-20220707222739120](MySql重要知识点/image-20220707222739120.png)

<img src="MySql重要知识点/image-20220707223024163.png" alt="image-20220707223024163" style="float:left;" />
...
<img src="MySql重要知识点/image-20220707223246684.png" alt="image-20220707223246684" style="float:left;" />

<img src="MySql重要知识点/image-20220707223349879.png" alt="image-20220707223349879" style="float:left;" />



### 5.3 MySQL 8.0新特性：隐藏索引对调优的帮助

<img src="MySql重要知识点/image-20220707223420496-1683882349612-434.png" alt="image-20220707223420496" style="float:left;" />
